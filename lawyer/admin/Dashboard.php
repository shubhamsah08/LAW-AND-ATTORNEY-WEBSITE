			...
			<div class="page-titles">
				<ol class="breadcrumb">
					...
					<div class="row">
						...
						<div class="col-sm-6">
						   <div id="piechart2" class="responsive"></div>
						</div>

						<div class="col-sm-6">
						   <div id="piechart3" class="responsive"></div>
						</div>
...
<!-- Mirrored from w3crm.Manasvi Tech Solutions Pvt Ltd.com/xhtml/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 15 Mar 2023 03:14:16 GMT -->
</html>
        ...
        {
            {
                ...
                function (data)
                {
                    ...
                    for (var i in data) {
                        order_status.push(data[i].order_status);
