...
<!-- Mirrored from w3crm.Manasvi Tech Solutions Pvt Ltd.com/xhtml/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 15 Mar 2023 03:13:42 GMT -->
<head>
    <meta charset="utf-8">
	...
	<!-- <link rel="shortcut icon" type="image/png" src="../img/hero/logo.png"> -->
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="Dashboard.php" class="brand-logo">
            	<!-- <img src="../img/hero/logo.png" width="70" height="50" style="justify-content: center;"></a> -->
                        ...
                        <div class="dropdown-menu dropdown-menu-end" style="">
                            <div class="card border-0 mb-0">
                                ...
                                <div class="card-body px-0 py-2">
                                	<!-- <a href="Edit_permission.php?id=<?php echo $res['id']; ?>" class="btn btn-danger">Change Permission</a></td>
                                    <a href="edit_profile.php?id=<?php echo $_SESSION['id']; ?>"class="dropdown-item ai-icon "> -->
